...
useEffect(() => {
  ...
  const handleSubmit = async(event) => {
    ...
    const updateBorrowerDetails = {
        creditScore,
        nationalInsuranceNumber
    }

    try{
        await borrowerServices.updateBorrower(currentUserId, updateBorrowerDetails)
...
<section className="main-chkout">
    <div className="container">
       <h4>To accurately Get a Quote, please provide your NI number and Credit Score</h4>
        ...
        <div className="clear"></div>
               <button onClick={handleSubmit} className="btncus gtr">Get your rate</button>
